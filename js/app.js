const urlObtenerUsuarios = 'https://miespacio.ucol.mx/pramos12/js/api/obtenerUsuarios.php';
const urlAgregarUsuario = 'http://miespacio.ucol.mx/pramos12/js/api/agregarUsuario.php';
const urlEditarUsuario = 'http://miepacio.ucol.mx/pramos12/js/api/editarUsuario.php';
const urlBorrarUsuario = 'http://miespacio.ucol.mx/pramos12/js/api/borrarUsuario.php';
